...
const PASSENGER_TYPES = [
  ...
  { value: "senior",  label: "Senior Citizen",  color: "bg-amber-500/20 text-amber-500", discount: 0.20, penalty: 0.20 },
  { value: "pwd",     label: "PWD",         color: "bg-amber-500/20 text-amber-500", discount: 0.20, penalty: 0.20 },
] as const;
